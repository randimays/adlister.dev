        ...
        <div class="sign_in_col_2 col span_3_of_5">
          ...
          <form class="" action="index.html" method="post">
            <div class="form-item">
              ...
              <input type="text" title="Register Email Address" maxlength="50" id="regiter_email" name="email1" value="">
            </div>
            <div class="form-item">
              <label for="register_password">
                "Password"
              </label>
              <input class="passwordField" type="password" title="Register Password" maxlength="20" id="register_password" name="password1" value="">
            </div>
            <div class="form-item">
              <label for="regitster_passwordVerify">
                "Confirm Password" <span class="asterisk">*</span>
              </label>
              <input class="passwordConfirmField" type="password" title="Confirm Password" maxlength="20" id="register_passwordConfirm" name="password2"value="">
            </div>
            <div class="form-item">
              <button type="submit" name="register" title="Register" class="submit costco-button"></button>
                <span class="s1">
